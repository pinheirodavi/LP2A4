...
<body>
	...
	<form id="create_form" action="./controller">
		<input type="hidden" name="acao" id="acao"
			value="<%=CommandEnum.CREATE%>" />
		<table>
			<tr>
				<td>Matrícula :</td>
				<td><input class="edicao" type="text" id="matricula"
					name="matricula" /></td>
			</tr>
			<tr>
				<td>Nome :</td>
				<td><input class="edicao" type="text" id="nome" name="nome" />
				</td>
			</tr>
			<tr>
				<td>Endereço :</td>
				<td><input class="edicao" type="text" id="endereco"
					name="endereco" /></td>
			</tr>
			<tr>
				<td>Data Ingresso (AAAA-MM-DD) :</td>
				<td><input class="edicao" type="text" id="dataIngresso"
					name="dataIngresso" /></td>
			</tr>
			<tr>
				<td>Data Término (AAAA-MM-DD) :</td>
				<td><input class="edicao" type="text" id="dataConclusao"
					name="dataConclusao" /></td>
			</tr>
		</table>
